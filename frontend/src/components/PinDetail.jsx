    ...
    >
      ...
      className='w-full p-5 flex-1 xl:min-w-620'>
        <div className='flex items-center justify-between'>
          ...
          <a href={pinDetail.destination} rel='noreferrer' target='_blank'>
        ...
        <Link to={`user-profile/${pinDetail.postedBy?._id}`} className='flex gap-2 mt-5 items-center bg-white rounded-lg'>
          <img src={pinDetail.postedBy?.image} className='w-8 h-8 rounded-full obhect-cover'/>
        ...
        <Link to={`user-profile/${pinDetail.postedBy?._id}`}>
          <img src={pinDetail.postedBy?.image} className='w-8 h-8 rounded-full cursor-pointer'/>
        </Link>
        <input
        type='text'
